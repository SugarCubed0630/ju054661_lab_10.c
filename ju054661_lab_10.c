...
void insert(struct Trie** ppTrie, char* word) { // function inserts a word into the trie. 
...
int numberOfOccurances(struct Trie* pTrie, char* word) { //function searches for a word in the trie and returns the number of occurrences of the word. 
